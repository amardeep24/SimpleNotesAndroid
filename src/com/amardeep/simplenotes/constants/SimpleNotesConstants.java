package com.amardeep.simplenotes.constants;

public class SimpleNotesConstants {
	public static final String NOTE_GET_URL="http://2-dot-simple-notes-project.appspot.com/pages/getNotes.do";
